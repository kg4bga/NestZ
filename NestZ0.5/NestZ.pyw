...
class NestedZipExtractor:
    ...
    def create_widgets(self):
        ...
        title = ttk.Label(header, text="Nested ZIP Extractor", font=("Segoe UI", 16, "bold"))
        ...
        # Drag & Drop hint
        if DND_AVAILABLE:
            hint = ttk.Label(main_frame, text="Drag & drop a ZIP file anywhere on this window", foreground="gray")
        else:
            hint = ttk.Label(main_frame, text="Drag & Drop unavailable (tkinterdnd2 not installed)", foreground="#cc4444")
        hint.pack(pady=(0, 12))
        ...
        self.extract_btn.pack(pady=12, ipadx=15, ipady=6)
